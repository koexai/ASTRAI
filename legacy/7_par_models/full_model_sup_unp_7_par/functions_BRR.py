...
def get_rrmse(y, y_pred):
    # Calcola il Relative RMSE (RMSE diviso per la media dei valori assoluti del target)
    # Usiamo il valore assoluto della media per evitare divisioni per zero o valori negativi
...
def get_best_params(max_iter_values, alpha_1_values, alpha_2_values, lambda_1_values, lambda_2_values,
    ...
    for max_iter, alpha_1, alpha_2, lambda_1, lambda_2 in combinations:
